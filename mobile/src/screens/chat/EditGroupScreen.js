...
export default function EditGroupScreen() {
  ...
  const takePhoto = useCallback(async () => {
    ...
    try {
      ...
      if (status !== "granted") {
        Alert.alert("Permission needed", "Allow camera access to set group photo.");
        return;
      }
  ...
  }, [chatId, groupName, avatarUrl, initialGroupAvatarUrl, navigation, updateChatInList]);
