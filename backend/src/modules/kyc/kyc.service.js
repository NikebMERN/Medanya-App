...
async function submit(reqUser, { docType, docNumber, frontImageUrl, backImageUrl, consent }) {
    ...
    const last4Val = last4(docNumber || "");
...
async function adminApprove(submissionId, adminUserId) {
